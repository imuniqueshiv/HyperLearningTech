  ...
  &quot;Minimizing Distractions, Maximizing Clarity.&quot;
            ...
            >
              <div>
                ...
                <p className="mt-1.5 font-medium text-sm text-muted-foreground">PYQ Coverage</p>
              </div>
              <div>
                <p className="text-3xl font-black text-foreground">100%</p>
                <p className="mt-1.5 font-medium text-sm text-muted-foreground">Syllabus Mapped</p>
              </div>
              <div>
                <p className="text-3xl font-black text-foreground">24/7</p>
                <p className="mt-1.5 font-medium text-sm text-muted-foreground">AI Assistant</p>
              </div>
            </motion.div>
          </motion.div>
      ...
      <div className="flex justify-start">
        <div className="max-w-[90%] rounded-2xl rounded-bl-md border border-border bg-card px-5 py-4">
          ...
          <p className="mt-3 text-sm leading-7 text-foreground/80">
            ...
            complexity because each element may need to be checked once.
          </p>
        </div>
      </div>
