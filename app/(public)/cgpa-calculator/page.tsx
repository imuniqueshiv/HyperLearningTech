      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 mb-24 relative z-10">
          ...
          >
            ...
            <div className="flex-1 w-full min-h-[450px] sm:min-h-[500px] lg:min-h-[540px] p-6 sm:p-8 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] md:rounded-[3rem] border border-white/80 dark:border-white/[0.04] bg-indigo-50/90 dark:bg-[#030712]/80 dark:bg-gradient-to-br dark:from-white/[0.03] dark:to-transparent shadow-[0_30px_100px_-15px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.8)] ring-1 ring-inset ring-transparent dark:ring-white/[0.03] flex flex-col justify-center items-center relative overflow-hidden backdrop-blur-3xl z-10">
