...
import { 
  Calculator, Target, Info, AlertTriangle, CheckCircle2, 
  GraduationCap, History, BarChart, TrendingUp, BookOpen, 
  Lightbulb, Award, Star, Briefcase, ShieldCheck, Compass
} from "lucide-react";
    ...
    <main className="relative min-h-screen pt-24 pb-20 overflow-hidden bg-slate-50/80 dark:bg-[#040814]">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            Target CGPA <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Calculator</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Find out exactly how much SGPA you need to score in your remaining semesters to reach your graduation goal.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="mt-10 flex items-start gap-4 p-5 rounded-2xl bg-slate-50/80 dark:bg-white/[0.02] border border-slate-100 dark:border-white/[0.05]">
              ...
              <p className="text-[13px] text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                This calculator uses average arithmetic weighting across semesters. If your university uses significantly different total credits per semester, your required SGPA may vary slightly.
              </p>
            </div>
          </motion.div>
              ...
              <AnimatePresence mode="wait">
                {!currentCgpa || !targetCgpa ? (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 mb-3">Awaiting Inputs</h3>
                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                      Enter your current and target CGPA to reveal your custom academic roadmap.
                    </p>
                  </motion.div>
                ) : error ? (
                  <motion.div
                  ...
                  >
                    {result > 10 ? (
                      <div className="space-y-5">
                        ...
                        <h3 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Mathematically Impossible!</h3>
                        <p className="text-[15px] font-medium leading-relaxed text-slate-600 dark:text-slate-400">
                          This target mathematically requires an SGPA of <strong className="text-red-600 dark:text-red-400">{result.toFixed(2)}</strong>, which exceeds the <strong className="text-slate-900 dark:text-white">10.0</strong> maximum threshold. We recommend setting a more realistic academic milestone.
                        </p>
                      </div>
                    ) : result <= 0 ? (
                      <div className="space-y-5">
                        ...
                        <h3 className="text-[13px] font-bold uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-1">Goal Surpassed</h3>
                        <div className="text-[72px] leading-none font-black text-slate-900 dark:text-white tracking-tighter drop-shadow-sm">
                          0.00
                        </div>
                        <p className="text-[15px] font-medium leading-relaxed text-slate-600 dark:text-slate-400">
                          Your current performance is so strong that you will achieve your target even if you score a <strong className="text-slate-900 dark:text-white">0.00 SGPA</strong> in your remaining semesters!
                        </p>
                      </div>
                      ...
                      <div className="space-y-5">
                        ...
                        <h3 className="text-[13px] font-bold uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-1">Target Secured</h3>
                        <div className="text-[72px] leading-none font-black text-slate-900 dark:text-white tracking-tighter drop-shadow-sm">
                          {result.toFixed(2)}
                        </div>
                        <p className="text-[15px] font-medium leading-relaxed text-slate-600 dark:text-slate-400">
                          You are currently pacing ahead of your goal! Simply maintain this baseline SGPA across your final <strong className="text-slate-900 dark:text-white">{totalSemesters - currentSemester}</strong> semesters to secure your target.
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-5 w-full">
                        <h3 className="text-[13px] font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400 mb-1">Required Average SGPA</h3>
                        <div className="text-[72px] leading-none font-black text-slate-900 dark:text-white tracking-tighter drop-shadow-sm">
                          {result.toFixed(2)}
                        </div>
                        ...
                        <div className="w-full pt-4 pb-2">
                          <div className="flex justify-between text-xs font-bold text-slate-500 mb-2">
                            ...
                            <span className="text-indigo-600 dark:text-indigo-400">Target: {targetCgpa}</span>
                          </div>
                        ...
                        <p className="text-[15px] font-medium leading-relaxed text-slate-600 dark:text-slate-400">
                          Maintain this precise minimum SGPA across your remaining <strong className="text-slate-900 dark:text-white">{totalSemesters - currentSemester}</strong> semesters to successfully unlock your target CGPA.
                        </p>
                      </div>
                    )}
                  </motion.div>
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 dark:text-slate-400 font-medium">
              Understand your grades and discover actionable ways to boost your SGPA.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-[32px] border border-slate-200/60 dark:border-white/10 bg-white dark:bg-white/[0.02] backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-8 relative z-10">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Placement Radar</h3>
              </div>
              
              <div className="space-y-6 relative z-10">
                <div className="space-y-3">
                  <label className="text-[13px] font-bold tracking-wider uppercase text-slate-600 dark:text-slate-400">Target Career Path</label>
                  <div className="grid grid-cols-1 gap-2">
                    {[
                      { id: "tier1", label: "Tier-1 Product (Google, Microsoft)", cutoff: 8.0 },
                      { id: "core", label: "Core Engineering & PSUs", cutoff: 7.5 },
                      { id: "tier2", label: "Tier-2 Tech & Consulting", cutoff: 7.0 },
                      { id: "mass", label: "Mass Recruiters (TCS, Infosys)", cutoff: 6.0 }
                    ].map((tier) => (
                      <button
                        key={tier.id}
                      ...
                      >
                        <span className={`font-semibold ${radarTier === tier.id ? "text-indigo-700 dark:text-indigo-300" : "text-slate-700 dark:text-slate-300"}`}>
                          {tier.label}
                        </span>
                        <span className={`text-[13px] font-bold px-2.5 py-1 rounded-md ${radarTier === tier.id ? "bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300" : "bg-slate-200/50 dark:bg-white/10 text-slate-600 dark:text-slate-400"}`}>
                          {tier.cutoff}+
                        </span>
                      </button>
                    ))}
                ...
                {(() => {
                  const cutoffs: Record<string, number> = { tier1: 8.0, core: 7.5, tier2: 7.0, mass: 6.0 };
                  ...
                  if (!currentCgpa || isNaN(current)) {
                    return (
                      <div className="p-5 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 text-center">
                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                          Enter your current CGPA above to see your eligibility status.
                        </p>
                      </div>
                    );
                  }
                  ...
                  if (current >= required) {
                    return (
                      <div className="flex gap-4 p-5 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20">
                        ...
                        <div>
                          <h4 className="font-bold text-emerald-800 dark:text-emerald-300 mb-1">Safe Zone</h4>
                          <p className="text-[13px] text-emerald-700 dark:text-emerald-400/80 leading-relaxed font-medium">
                            Your CGPA comfortably meets the standard {required.toFixed(1)} cutoff for this tier. Focus heavily on DSA and interview prep!
                          </p>
                        </div>
                      </div>
                    );
                    ...
                    return (
                      <div className="flex gap-4 p-5 rounded-2xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20">
                        ...
                        <div>
                          <h4 className="font-bold text-amber-800 dark:text-amber-300 mb-1">Borderline</h4>
                          <p className="text-[13px] text-amber-700 dark:text-amber-400/80 leading-relaxed font-medium">
                            You are very close to the {required.toFixed(1)} cutoff. Pushing your CGPA up slightly in remaining semesters will safely unlock this tier.
                          </p>
                        </div>
                      </div>
                    );
                    ...
                    return (
                      <div className="flex gap-4 p-5 rounded-2xl bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20">
                        ...
                        <div>
                          <h4 className="font-bold text-red-800 dark:text-red-300 mb-1">Action Required</h4>
                          <p className="text-[13px] text-red-700 dark:text-red-400/80 leading-relaxed font-medium">
                            You are currently falling short of the {required.toFixed(1)} cutoff. Don't panic! Set <strong className="text-red-800 dark:text-red-300">{required.toFixed(1)}</strong> as your Target CGPA above to calculate the exact comeback strategy you need in your remaining semesters.
                          </p>
                        </div>
                      </div>
                    );
            ...
            <div className="p-8 rounded-[32px] border border-slate-200/60 dark:border-white/10 bg-white dark:bg-white/[0.02] backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Pro-Tips for Higher SGPA</h3>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4 p-4 rounded-2xl border border-slate-100 dark:border-white/5 bg-slate-50/50 hover:bg-slate-50 dark:bg-white/5 dark:hover:bg-white/10 shadow-sm transition-colors cursor-default">
