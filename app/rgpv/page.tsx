  ...
  return (
    <main className="relative min-h-screen dark:bg-background overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden dark:hidden bg-[#FCFCFD]">
        {/* Intricate 3-Color Mesh Gradient with Multiply Blending */}
        <div className="absolute -left-[15%] -top-[10%] h-[1000px] w-[1000px] rounded-full bg-sky-200/30 blur-[130px] mix-blend-multiply"></div>
        <div className="absolute -right-[15%] top-[5%] h-[900px] w-[900px] rounded-full bg-fuchsia-200/25 blur-[130px] mix-blend-multiply"></div>
        <div className="absolute left-[20%] -bottom-[20%] h-[800px] w-[800px] rounded-full bg-indigo-200/20 blur-[130px] mix-blend-multiply"></div>

        {/* Pure white glow in the center-top to maintain high contrast for the main content */}
        <div className="absolute left-1/2 top-[-15%] h-[700px] w-[900px] -translate-x-1/2 rounded-full bg-white/90 blur-[100px]"></div>
