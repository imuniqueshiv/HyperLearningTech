...
const TwitterIcon = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" /></svg>
);
...
const YoutubeIcon = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2.5 7.1C2.5 5 4.5 3 7.1 3h9.8C19 3 21.5 5 21.5 7.1v9.8c0 2.1-2.5 4.1-4.6 4.1H7.1C4.5 21 2.5 19 2.5 16.9V7.1z"/><path d="m10 15 5-3-5-3v6z"/></svg>
);

const SocialDropdown = ({ icon: Icon, label, links, size = "sm", hoverClass }: any) => {
  ...
  const btnClasses = baseClasses + (hoverClass || "hover:border-blue-500/40 dark:hover:border-blue-500/40 hover:bg-blue-50 dark:hover:bg-blue-500/5 hover:text-blue-600 dark:hover:text-blue-400 hover:shadow-md dark:hover:shadow-[0_0_15px_rgba(59,130,246,0.2),inset_0_1px_1px_rgba(255,255,255,0.1)]");

  const iconClasses = size === "md" 
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 py-10 md:px-12 lg:px-16 xl:px-20 z-10">
        ...
        <div className="flex flex-col xl:flex-row xl:justify-between gap-10 xl:gap-8">
              ...
              <ul className="space-y-3.5">
                {[
                  ...
                  <li key={item.name}>
                    ...
                    >
                      <span className="mr-2.5 text-[14px] text-slate-300 dark:text-slate-700/50 transition-all duration-300 group-hover:text-blue-500 dark:group-hover:text-blue-400 group-hover:drop-shadow-[0_0_6px_rgba(59,130,246,0.5)]">•</span>
                      {item.name}
                    </Link>
                  </li>
                ))}
          ...
          <div className="w-full xl:border-l xl:border-slate-200 dark:xl:border-white/[0.03] xl:pl-10">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 h-full">
              {[
                { title: "AI-Powered", desc: "Smarter learning for better results", icon: Zap },
                { title: "Trusted & Secure", desc: "Your data is safe and protected", icon: Shield },
                { title: "Built for Engineers", desc: "Designed by learners, for learners", icon: Users },
                { title: "Always Updated", desc: "New content & features added", icon: Bell },
              ].map((feature, idx) => (
                <div 
                  key={idx} 
                ...
                >
                  ...
                  <div className="relative mb-3.5 flex items-center justify-center">
                    ...
                    <feature.icon className="relative z-10 h-[22px] w-[22px] text-blue-600 dark:text-blue-400/80 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] group-hover:scale-110 group-hover:text-blue-500 dark:group-hover:text-blue-300 group-hover:drop-shadow-[0_0_12px_rgba(59,130,246,0.3)] dark:group-hover:drop-shadow-[0_0_12px_rgba(59,130,246,0.6)]" strokeWidth={1.75} />
                  </div>
                  
                  <h4 className="text-[13px] font-extrabold tracking-wide text-slate-900 dark:text-white/80 drop-shadow-sm dark:drop-shadow-[0_1px_2px_rgba(255,255,255,0.15)]">{feature.title}</h4>
                  <p className="mt-2 text-[11px] leading-[1.6] text-slate-500 dark:text-slate-300/80 font-medium">{feature.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-10 flex h-auto flex-col items-center justify-between gap-5 rounded-[20px] border border-[#C2D4EA] dark:border-white/[0.05] bg-[#EDF2F8] dark:bg-white/[0.01] backdrop-blur-lg px-6 py-4 shadow-sm dark:shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.04)] lg:h-[48px] lg:flex-row lg:rounded-full lg:px-8 lg:py-0 transition-all hover:border-slate-300 dark:hover:border-white/[0.08]">
          ...
          <p className="text-[11.5px] font-medium text-slate-500 dark:text-slate-400/80 text-center flex-1 mx-4">
            <span className="text-slate-700 dark:text-slate-300">Disclaimer:</span> Some content may contain errors. Please cross-check and share corrections via our feedback section.
          </p>

          {/* Right: Socials */}
          <div className="flex items-center gap-4 shrink-0">
            <span className="text-[11px] font-bold tracking-wider uppercase text-slate-900 dark:text-slate-400/80">Follow Us</span>
            <div className="flex items-center gap-2">
              {[
                { 
                  icon: InstagramIcon, 
                  label: "Instagram",
                  hoverClass: "hover:bg-blue-600 hover:border-blue-600 hover:text-white hover:shadow-md dark:hover:border-pink-500/40 dark:hover:bg-pink-500/5 dark:hover:text-pink-400 dark:hover:shadow-[0_0_15px_rgba(236,72,153,0.2),inset_0_1px_1px_rgba(255,255,255,0.1)]",
                  links: [
                    { name: "Nitin's Instagram", url: "https://www.instagram.com/nitin__.pandey/" },
                    { name: "Ramu's Instagram", url: "https://www.instagram.com/frrr_ace/" }
                  ]
                },
                { 
                  icon: LinkedinIcon, 
                  label: "LinkedIn",
                  hoverClass: "hover:bg-blue-600 hover:border-blue-600 hover:text-white hover:shadow-md dark:hover:border-[#0A66C2]/40 dark:hover:bg-[#0A66C2]/5 dark:hover:text-[#0A66C2] dark:hover:shadow-[0_0_15px_rgba(10,102,194,0.3),inset_0_1px_1px_rgba(255,255,255,0.1)]",
                  links: [
                    { name: "Nitin's LinkedIn", url: "https://linkedin.com/in/nitin-mohan-9251ab328" },
                    { name: "Ramu's LinkedIn", url: "https://www.linkedin.com/in/ramoo-kachhee-9b1616405/" }
                  ]
                },
                { 
                  icon: GithubIcon, 
                  label: "GitHub",
                  hoverClass: "hover:bg-blue-600 hover:border-blue-600 hover:text-white hover:shadow-md dark:hover:border-white/40 dark:hover:bg-white/5 dark:hover:text-white dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.15),inset_0_1px_1px_rgba(255,255,255,0.1)]",
                  links: [
                    { name: "Nitin's GitHub", url: "https://github.com/nitinmohan18" },
                    { name: "Ramu's GitHub", url: "https://github.com/RamuuXfree" }
                  ]
                }
              ].map((social, idx) => (
                <SocialDropdown key={idx} size="sm" icon={social.icon} label={social.label} links={social.links} hoverClass={social.hoverClass} />
              ))}
              ...
              >
                <Globe strokeWidth={2.5} className="h-[16px] w-[16px] transition-transform duration-300 group-hover:scale-105" />
              </a>
            </div>
          </div>
